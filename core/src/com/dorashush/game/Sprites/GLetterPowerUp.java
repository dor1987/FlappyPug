...
public class GLetterPowerUp  extends PowerUp {

    public GLetterPowerUp(PlayScreen screen) {
        super(screen);
        powerUpSymbol = new TextureRegion(manager.get("images/g.png",Texture.class));
        value = 'g';
