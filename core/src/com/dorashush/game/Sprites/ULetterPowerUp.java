...
public class ULetterPowerUp  extends PowerUp{

    public ULetterPowerUp(PlayScreen screen) {
        super(screen);
        powerUpSymbol = new TextureRegion(manager.get("images/u.png",Texture.class));
        value = 'u';
