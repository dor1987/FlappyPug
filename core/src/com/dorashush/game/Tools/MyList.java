...
public class MyList<T> extends Widget implements Cullable {
    ...
    public MyList (List.ListStyle style) {
        ...
        addListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                getStage().setKeyboardFocus(MyList.this);
                if (items.size == 0) return false;
                float height = getHeight();
                Drawable background = MyList.this.style.background;
                if (background != null) {
    ...
    public void layout () {
        ...
        //itemHeight = ((TextButton)items.get(0)).getHeight();
    ...
    public void draw (Batch batch, float parentAlpha) {
        validate();
        itemHeight = ((MyTextButton)items.get(0)).getHeight();
        BitmapFont font = style.font;
        Drawable selectedDrawable = style.selection;
        ...
        for (int i = 0; i < items.size; i++) {
          //  if (cullingArea == null || (itemY - itemHeight <= cullingArea.y + cullingArea.height && itemY >= cullingArea.y)) {
                ...
                ((MyTextButton)item).setBounds(x,y+ itemY - ((MyTextButton)item).getHeight(),width,((MyTextButton)item).getHeight());
                ((MyTextButton)item).draw(batch,parentAlpha);
           ...
           // }
            ...
            itemY -= ((MyTextButton)items.get(0)).getHeight() ;
        }
    }
